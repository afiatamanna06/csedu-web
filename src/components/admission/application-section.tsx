...
const ApplicationSection: React.FC<ApplicationSectionProps> = ({ programType }) => {
    ...
    <>
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100 mb-12">
        ...
        <div className="space-y-6 text-lg text-gray-700">
          <div>
            <h3 className="font-semibold text-[#13274C]">1. Completed Application Form</h3>
          ...
          <div>
            <h3 className="font-semibold text-[#13274C]">2. Academic Documents</h3>
            <ul className="list-disc pl-6 mt-2 space-y-2">
          ...
          <div>
            <h3 className="font-semibold text-[#13274C]">3. Recommendation Letters</h3>
            <p className="mt-2">2 letters (academic supervisors preferred)</p>
          </div>
          <div>
            <h3 className="font-semibold text-[#13274C]">4. Research Proposal ({programType} only)</h3>
      ...
      <div className="grid md:grid-cols-2 gap-10 mt-12 mb-12">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
          ...
          <ul className="space-y-4 text-lg text-gray-700">
            <li className="flex items-start">
              <span className="font-semibold min-w-[120px]">January 1, 2025</span>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
          ...
          <div className="space-y-4 text-lg text-gray-700">
            <div>
              <h3 className="font-semibold text-[#13274C]">What is the application fee?</h3>
              <p className="mt-1">The application fee is 1000 BDT for {programType} program.</p>
            </div>
            <div>
              <h3 className="font-semibold text-[#13274C]">Can I apply for multiple programs?</h3>
              <p className="mt-1">Yes, you can apply for multiple programs but you need to submit separate applications.</p>
            </div>
            <div>
              <h3 className="font-semibold text-[#13274C]">Is there any scholarship available?</h3>
              <p className="mt-1">Yes, there are merit-based scholarships available for outstanding students.</p>
            </div>
          </div>
        </div>
      </div>
