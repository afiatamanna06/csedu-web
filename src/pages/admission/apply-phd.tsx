    ...
    <div className="pt-24">
      ...
      <div className="mx-8 mb-8">
        ...
        <div className="bg-[#FFC300] py-4 px-6 rounded-b-lg shadow-md">
          <h1 className="text-3xl font-bold text-[#13274C]">Admission – PhD</h1>
        </div>
      </div>
      ...
      <div className="container mx-auto px-8 max-w-6xl">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100 mb-12">
          ...
          <p className="text-lg text-gray-700 mb-6">
            At the Department of CSE, University of Dhaka, we look beyond grades to understand your potential as a future researcher and academic. We consider your analytical abilities, technical proficiency, research experience, academic rigor, and passion for innovation—whether demonstrated through coursework, projects, publications, or extracurricular engagement.
          </p>
        ...
        <ApplicationSection programType="PhD" />
      </div>
    </div>
  );
};

export default ApplyPhd;