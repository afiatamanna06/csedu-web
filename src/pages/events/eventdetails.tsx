...
//   // Try to parse as 'YYYY-MM-DD' only
...
//   const registrationDeadline = safeParseDate(event.registrationDeadline) || eventDate;
//   const isRegistrationOpen = event.registrationOpen && !event.registrationClosed && now <= registrationDeadline && now <= eventDate
//   const isEventFull = event.maxAttendees && event.currentAttendees >= event.maxAttendees
...
//             )}
//             {/* Then show detailed description if available */}
//             {event.detailedDescription && event.detailedDescription.trim() && (
